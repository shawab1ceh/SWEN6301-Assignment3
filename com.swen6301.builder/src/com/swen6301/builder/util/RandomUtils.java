...
public class RandomUtils {
	...
	public enum BloodType {
		...
		BloodType(String label) {
			this.label = getRandomBlood();
		}

		public static BloodType getRandomBloodType() {
			return BloodType.values()[new Random().nextInt(BloodType.values().length)];
		}

//		
		public String getRandomBlood() {
			getRandomBloodType();
